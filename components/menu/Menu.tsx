  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.whiteBox}>
        {/* Balances */}
        <TouchableOpacity style={styles.sectionBtn} onPress={() => navigation.navigate('BalancesScreen')}>
          <View>
        ...
        {/* Purchase History */}
        <TouchableOpacity style={styles.sectionBtn} onPress={() => navigation.navigate('HistoryScreen')}>
          <View>
        ...
        {/* Profile */}
        <TouchableOpacity style={styles.sectionBtn} onPress={() => navigation.navigate('ProfileScreen')}>
          <View>
      ...
      <View style={styles.whiteBox}>
        {/* Contact */}
        <TouchableOpacity style={styles.sectionBtn} onPress={() => navigation.navigate('ContactScreen')}>
          <View>
        ...
        {/* Recharge help */}
        <TouchableOpacity style={styles.sectionBtn} onPress={() => navigation.navigate('RechargeScreen')}>
          <View>
